...
<h4>The artifact that I will be using is from full stack development 465. The original project is a website that is used for traveling to vacation spots. The artifact used databases to store the vacation information as well as pictures of the locations. The artifact </h4>  
